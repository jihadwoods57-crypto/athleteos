...
export function renderAlertEmail({ kind, subject, body, details, actionUrl, occurredAt }) {
  ...
  const ctaBlock = actionUrl ? `
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:26px 0 6px">
      <tr><td style="border-radius:8px" bgcolor="#2563EB">
        <a href="${escapeHtml(actionUrl)}" target="_blank" style="display:inline-block;padding:12px 22px;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:8px;background:#2563EB">${escapeHtml(meta.actionLabel)} &rarr;</a>
      </td></tr>
    </table>` : '';
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f2f4f7;padding:32px 16px">
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 1px 3px rgba(16,24,40,.08)">
        <tr><td style="height:4px;background:linear-gradient(120deg,#34D399,#22D3EE,#3B82F6);line-height:0;font-size:0">&nbsp;</td></tr>
        <tr><td style="padding:28px 32px 0">
          <!-- Performance Dial + two-tone wordmark (brand law, docs/brand/LOGO.md). Hosted PNG
               because Gmail strips inline SVG; regenerated by scripts/gen-brand-assets.mjs. -->
          <table role="presentation" cellpadding="0" cellspacing="0"><tr>
            <td style="width:26px;height:26px"><img src="https://onstandard.app/assets/brand/email-mark.png" width="26" height="26" alt="" style="display:block;border-radius:8px;width:26px;height:26px"></td>
            <td style="padding-left:11px;font-size:15px;font-weight:700;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif"><span style="color:#161b22">On</span><span style="color:#2563EB">Standard</span>
