...
- **Card body:** Your score starts at zero and moves the second you log. Photo proof — Nutrition is 82% of the number. **(keep existing)** <!-- lint-score-ok: reviewed static-copy literal -->
