...
**4 DONE** (nudge + note + trail, `a60f919`) → **3 DONE** (editable meal portions that
recompute macros/quality/composition, `21a2905`) → **all safe phases complete.**
**next: 1 (keystone — real backend go-live, FOUNDER gate)** → 6 (consent) → 2c-perf-signal.
