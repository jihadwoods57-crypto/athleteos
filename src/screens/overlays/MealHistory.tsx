...
function EmptyState() {
  return (
    <View style={{ alignItems: 'center', paddingTop: 60, paddingHorizontal: 24 }}>
      <View style={{ width: 64, height: 64, borderRadius: 20, backgroundColor: colors.bg2, alignItems: 'center', justifyContent: 'center' }}>
        <Icon name="camera" size={28} color={colors.textTertiary} />
      </View>
      <Txt w="eb" size={17} style={{ marginTop: 16 }}>
        No meals yet
      </Txt>
      <Txt w="m" size={14} color={colors.textSecondary} style={{ marginTop: 6, textAlign: 'center', lineHeight: 21 }}>
