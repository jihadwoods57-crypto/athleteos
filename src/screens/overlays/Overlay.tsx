...
export function Overlay({
  ...
  return (
    <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: bg ?? c.bg, zIndex: 100 }}>
        ...
        <SafeAreaView edges={['top']} style={{ flex: 1 }}>
          <Row style={{ justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 12, paddingBottom: 14 }}>
            <Pressable
              ...
              hitSlop={6}
              onPress={onClose}
              style={[{ width: 40, height: 40, borderRadius: 13, backgroundColor: c.card, alignItems: 'center', justifyContent: 'center' }, shadow.card]}
            >
              <Icon name={closeIcon} size={20} color={c.slate600} />
            </Pressable>
