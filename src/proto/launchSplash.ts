...
/** Longest the splash may stay up waiting for PAINTED, from the shell's first render. */
export const SPLASH_MAX_MS = 4000;

let held = false;
let released = false;

/** Call at module scope, before the router can auto-hide (Expo's documented pattern). */
