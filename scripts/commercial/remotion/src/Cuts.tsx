...
export const Preroll30: React.FC = () => (
  <AbsoluteFill style={{ background: C.bg }}>
    ...
    <Sequence from={96} durationInFrames={150}>
      ...
      <Phone src="rollcall" startFrom={10} height={904} shiftX={330} />
    ...
    <Sequence from={246} durationInFrames={216}>
      ...
      <Phone src="snap" startFrom={16} height={904} shiftX={330} />
    ...
    <Sequence from={462} durationInFrames={192}>
      ...
      <Phone src="ring" startFrom={24} height={940} shiftY={40} shiftX={330} />
...
export const Vertical15: React.FC = () => (
  <AbsoluteFill style={{ background: C.bg }}>
    ...
    <Sequence from={0} durationInFrames={180}>
      <BackPlate src="s2" frame={130} />
      <Phone src="snap" startFrom={40} height={1500} appear={false} punchFrom={1.02} punchTo={1.07} shiftY={60} />
    ...
    <Sequence from={180} durationInFrames={162}>
      <BackPlate src="s5" frame={130} />
      <Phone src="ring" startFrom={24} height={1500} punchFrom={1} punchTo={1.06} shiftY={60} />
