        ...
        <tr><td style="padding:30px 34px 0">
          <table role="presentation" cellpadding="0" cellspacing="0"><tr>
            <td style="width:30px;height:30px">
              <!-- The Performance Dial (brand law, docs/brand/LOGO.md). Hosted PNG because
                   Gmail strips inline SVG; regenerated by scripts/gen-brand-assets.mjs. -->
              <img src="https://onstandard.app/assets/brand/email-mark.png" width="30" height="30" alt="" style="display:block;border-radius:9px;width:30px;height:30px">
            </td>
