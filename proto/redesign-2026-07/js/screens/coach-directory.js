  ...
  render({ sub }) {
    ...
    <section class="card" style="padding:6px 16px">
      ...
      <div class="lrow" data-go="coach-listing/${esc(l.slug)}" style="align-items:flex-start">
        <div class="lic" style="background:linear-gradient(150deg,var(--blue),var(--blue-deep));color:var(--ink-on-accent);font-weight:800;font-size:14px">${esc(monogram(l.display_name))}</div>
