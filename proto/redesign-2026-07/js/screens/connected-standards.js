...
// The Home card and the pieces it shares now live in standards-card.js, so Home can draw the
// card without pulling this whole screen into the boot graph. Re-exported below because other
