  ...
  /* ==================== ch0 · Discover ==================== */
  {
    ...
    body: () => `
      <div class="ob2-hero">
        ...
        <h1 class="h-title">Your value shouldn’t stop <span class="accent">when the session ends.</span></h1>
  ...
  },
  {
    ...
    body: () => `
      <div class="ob2-hero">
        ...
        <h1 class="h-title">Chasing clients by text <span class="accent">is unpaid work.</span></h1>
  ...
  },
  {
    ...
    body: () => `
      <div class="ob2-hero">
        ...
        <h1 class="h-title">Clients who see progress <span class="accent">stay.</span></h1>
