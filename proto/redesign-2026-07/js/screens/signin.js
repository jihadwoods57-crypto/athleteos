...
export default {
  ...
  render() {
    ...
    <div class="welcome" style="justify-content:flex-start;padding-top:64px">
      ...
      <input id="si-email" class="ob-input" type="email" inputmode="email" autocapitalize="none" autocorrect="off" spellcheck="false" placeholder="Email" aria-label="Email" />
      <div style="height:12px"></div>
      <input id="si-pass" class="ob-input" type="password" placeholder="Password" aria-label="Password" />
