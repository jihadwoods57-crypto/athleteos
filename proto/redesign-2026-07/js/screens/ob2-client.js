  ...
  { id: 'why', ch: 0, cta: 'Continue',
    body: () => `
      <div class="ob2-hero">
        ...
        <h1 class="h-title">Your trainer sees <span class="accent">3 hours</span> a week.</h1>
  ...
  { id: 'gap', ch: 0, cta: 'Continue',
    body: () => `
      <div class="ob2-hero" style="padding-bottom:8px">
        ...
        <h1 class="h-title">Your results are shaped by <span class="accent">the other 165.</span></h1>
      </div>
  ...
  { id: 'answer', ch: 0, cta: 'Show me',
    body: () => `
      <div class="ob2-hero">
        ...
        <h1 class="h-title">One number. <span class="accent">All 168 hours.</span></h1>
