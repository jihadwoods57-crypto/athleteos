  ...
  render() {
    ...
    <section class="card" style="padding:6px 16px">
      ...
      <div class="lrow" style="cursor:default;align-items:flex-start">
        ...
        ${o.price_cents != null ? `<button class="btn green sm" data-pay="${esc(o.offer_id)}" data-child="${esc(o.child_id)}" style="width:auto;padding:0 14px;height:34px;flex:none">${UI.paying === o.offer_id ? '…' : 'Pay'}</button>` : ''}
      </div>`).join('')}
    </section>`).join('') + `
