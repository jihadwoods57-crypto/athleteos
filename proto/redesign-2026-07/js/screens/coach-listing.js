...
export default {
  ...
  render({ sub }) {
    ...
    <section class="card pad" style="display:flex;gap:14px;align-items:center">
      <div class="lic" style="width:52px;height:52px;border-radius:16px;background:linear-gradient(150deg,#3B82F6,#22D3EE);color:#06121f;font-weight:800;font-size:19px">${esc(monogram(l.display_name))}</div>
      <div style="flex:1">
